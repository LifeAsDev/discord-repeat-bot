...
const scriptsInEvents = {
	...
	async EventWorld_Event321_Act1(runtime, localVars)
	{
...
sendInventory(result);
	...
	async EventWorld_Event468(runtime, localVars)
	{
	...
	async EventWorld_Event480(runtime, localVars)
	{

	},

	async EventWorld_Event496_Act1(runtime, localVars)
	{
	...
	async EventWorld_Event497_Act2(runtime, localVars)
	{
		const data = JSON.parse(localVars.jsonStringify);
		/* localVars.date = data.date;
		localVars.animationName = data.animationName;
	...
	async EventWorld_Event576_Act2(runtime, localVars)
	{
		await saveRoomData(runtime.globalVars.roomName, localVars.worldJson);
	},

	async EventWorld_Event583_Act1(runtime, localVars)
	{
