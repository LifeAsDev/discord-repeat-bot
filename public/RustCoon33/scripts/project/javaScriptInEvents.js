...
const scriptsInEvents = {
	...
	async EventWorld_Event366_Act1(runtime, localVars)
	{
...
sendInventory(result);
	...
	async EventWorld_Event509_Act1(runtime, localVars)
	{
		runtime.playersArr = [];
	},

	async EventWorld_Event513(runtime, localVars)
	{
	...
	async EventWorld_Event525(runtime, localVars)
	{

	},

	async EventWorld_Event541_Act1(runtime, localVars)
	{
	...
	async EventWorld_Event624_Act2(runtime, localVars)
	{
		await saveRoomData(runtime.globalVars.roomName, localVars.worldJson);
	},

	async EventWorld_Event631_Act1(runtime, localVars)
	{
	...
	async EventWorld_Event185_Act3(runtime, localVars)
	{
		const miniPos = worldToMinimap(
		  { x: localVars.px, y: localVars.py },
		  { width: 6400, height: 6400 },
