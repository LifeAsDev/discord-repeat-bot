...
const scriptsInEvents = {
	...
	{
		window.ServerList.onSelectServer =(name)=>{ runtime.callFunction("joinServer",name)}
	},
	...
	{
		window.listRoom.push(localVars.serverName);
	},
	...
	{
		 window.ServerList.updateServers(window.listRoom);
	},
